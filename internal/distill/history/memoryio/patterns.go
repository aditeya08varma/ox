...
// here gives the reader package (internal/distill/history/read) one shared source
...
// Drift detection:
//
//   - internal/distill/history/read/list.go compiles these constants directly, so
//     it cannot drift from memoryio by construction.
//   - cmd/ox/distill_history_citations_bridge_test.go pins cmd/ox's dailyDateRe /
