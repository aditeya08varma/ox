...
// parsers the reader (internal/journal/read) needs without importing the
// cmd/ox main package.
//
...
// round-trip tests in cmd/ox/journal_citations_bridge_test.go
// (TestJournalFrontmatterBridge_CanonicalParserRoundTrip and
// TestJournalCitationsBridge_CanonicalParserRoundTrip). Any drift
