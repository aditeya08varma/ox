...
<svg data-ox-viz="sequence-diagram" class="oxv-seq" viewBox="0 0 960 600" role="img" aria-labelledby="seq-title seq-desc" style="max-width:100%;height:auto;background:var(--panel,#111411);color:var(--ink,#f4f2ef)">
  ...
  <defs><marker id="seq-arrow" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><path d="M0 0 8 3 0 6Z" fill="var(--dim,#b7b6a3)"/></marker><marker id="seq-focus-arrow" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><path d="M0 0 8 3 0 6Z" fill="var(--gold,#d9b654)"/></marker></defs>
  <style>.oxv-seq text{font-family:Inter,system-ui,sans-serif;fill:currentColor}.oxv-seq .name{font-weight:600;font-size:16px}.oxv-seq .msg{font:12px "Spline Sans Mono",monospace;fill:var(--dim,#b7b6a3)}.oxv-seq .life{stroke:var(--hair,#212620);stroke-dasharray:5 5}.oxv-seq .edge{stroke:var(--dim,#b7b6a3);stroke-width:2;fill:none;marker-end:url(#seq-arrow)}.oxv-seq .focus{stroke:var(--gold,#d9b654);marker-end:url(#seq-focus-arrow)}.oxv-seq .node{fill:var(--bg,#0b0d0b);stroke:var(--hair,#212620);stroke-width:2}</style>
  ...
  <g data-ox-node data-ox-focus><rect x="380" y="48" width="200" height="64" rx="6" fill="var(--gold,#d9b654)" fill-opacity=".12" stroke="var(--gold,#d9b654)" stroke-width="2"/><text class="name" x="480" y="86" text-anchor="middle">API</text></g>
...
```html
<svg data-ox-viz="state-machine" class="oxv-state" viewBox="0 0 960 600" role="img" aria-labelledby="state-title state-desc" style="max-width:100%;height:auto;background:var(--panel,#111411);color:var(--ink,#f4f2ef)">
  ...
  <defs><marker id="state-arrow" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><path d="M0 0 8 3 0 6Z" fill="var(--dim,#b7b6a3)"/></marker></defs>
  <style>.oxv-state text{font-family:Inter,system-ui,sans-serif;fill:currentColor}.oxv-state .node{fill:var(--bg,#0b0d0b);stroke:var(--hair,#212620);stroke-width:2}.oxv-state .name{font-size:16px;font-weight:600}.oxv-state .guard{font:12px "Spline Sans Mono",monospace;fill:var(--dim,#b7b6a3)}.oxv-state .edge{fill:none;stroke:var(--dim,#b7b6a3);stroke-width:2;marker-end:url(#state-arrow)}</style>
  <circle cx="80" cy="300" r="12" fill="var(--ink,#f4f2ef)"/>
  ...
  <g data-ox-node data-ox-focus><rect x="410" y="250" width="190" height="100" rx="8" fill="var(--gold,#d9b654)" fill-opacity=".12" stroke="var(--gold,#d9b654)" stroke-width="2"/><text class="name" x="505" y="306" text-anchor="middle">In progress</text></g>
...
```html
<svg data-ox-viz="architecture" class="oxv-arch" viewBox="0 0 960 600" role="img" aria-labelledby="arch-title arch-desc" style="max-width:100%;height:auto;background:var(--panel,#111411);color:var(--ink,#f4f2ef)">
  ...
  <defs><marker id="arch-arrow" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><path d="M0 0 8 3 0 6Z" fill="var(--dim,#b7b6a3)"/></marker></defs>
  <style>.oxv-arch text{font-family:Inter,system-ui,sans-serif;fill:currentColor}.oxv-arch .zone{fill:var(--bg,#0b0d0b);stroke:var(--hair,#212620);stroke-width:2;stroke-dasharray:6 5}.oxv-arch .node{fill:var(--panel,#111411);stroke:var(--hair,#212620);stroke-width:2}.oxv-arch .name{font-size:16px;font-weight:600}.oxv-arch .tag{font:11px "Spline Sans Mono",monospace;fill:var(--dim,#b7b6a3)}.oxv-arch .edge{fill:none;stroke:var(--dim,#b7b6a3);stroke-width:2;marker-end:url(#arch-arrow)}</style>
  ...
  <g data-ox-node data-ox-focus><rect x="350" y="180" width="180" height="96" rx="6" fill="var(--gold,#d9b654)" fill-opacity=".12" stroke="var(--gold,#d9b654)" stroke-width="2"/><text class="name" x="440" y="236" text-anchor="middle">API boundary</text></g>
  ...
  <path data-ox-connector class="edge" d="M240 262H300Q320 262 320 242V228H350"/><path data-ox-connector class="edge" d="M530 228H650"/><path data-ox-connector class="edge" d="M740 234V340"/><path data-ox-connector class="edge" stroke="var(--teal,#97aebd)" d="M650 192H590Q570 192 570 212V415H530"/>
</svg>
```
...
```html
<svg data-ox-viz="flowchart" class="oxv-flow" viewBox="0 0 960 600" role="img" aria-labelledby="flow-title flow-desc" style="max-width:100%;height:auto;background:var(--panel,#111411);color:var(--ink,#f4f2ef)">
  ...
  <defs><marker id="flow-arrow" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><path d="M0 0 8 3 0 6Z" fill="var(--dim,#b7b6a3)"/></marker></defs>
  <style>.oxv-flow text{font-family:Inter,system-ui,sans-serif;fill:currentColor}.oxv-flow .node{fill:var(--bg,#0b0d0b);stroke:var(--hair,#212620);stroke-width:2}.oxv-flow .name{font-size:16px;font-weight:600}.oxv-flow .edge{fill:none;stroke:var(--dim,#b7b6a3);stroke-width:2;marker-end:url(#flow-arrow)}.oxv-flow .label{font:12px "Spline Sans Mono",monospace;fill:var(--dim,#b7b6a3)}</style>
  ...
  <g data-ox-node data-ox-focus><polygon points="480,160 610,240 480,320 350,240" fill="var(--gold,#d9b654)" fill-opacity=".12" stroke="var(--gold,#d9b654)" stroke-width="2"/><text class="name" x="480" y="246" text-anchor="middle">Valid?</text></g>
  <g data-ox-node><rect x="120" y="390" width="220" height="82" rx="6" fill="var(--bg,#0b0d0b)" stroke="var(--amber,#c6a23c)" stroke-width="2"/><text class="name" x="230" y="438" text-anchor="middle">Return useful error</text></g>
...
<svg data-ox-viz="data-flow" class="oxv-data" viewBox="0 0 960 600" role="img" aria-labelledby="data-title data-desc" style="max-width:100%;height:auto;background:var(--panel,#111411);color:var(--ink,#f4f2ef)">
  ...
  <defs><marker id="data-arrow" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><path d="M0 0 8 3 0 6Z" fill="var(--dim,#b7b6a3)"/></marker></defs>
  <style>.oxv-data text{font-family:Inter,system-ui,sans-serif;fill:currentColor}.oxv-data .node{fill:var(--bg,#0b0d0b);stroke:var(--hair,#212620);stroke-width:2}.oxv-data .name{font-size:15px;font-weight:600}.oxv-data .sub{font:11px "Spline Sans Mono",monospace;fill:var(--dim,#b7b6a3)}.oxv-data .edge{fill:none;stroke:var(--dim,#b7b6a3);stroke-width:2;marker-end:url(#data-arrow)}</style>
  ...
  <g data-ox-node data-ox-focus><rect x="265" y="210" width="180" height="140" rx="6" fill="var(--gold,#d9b654)" fill-opacity=".12" stroke="var(--gold,#d9b654)" stroke-width="2"/><text class="name" x="355" y="270" text-anchor="middle">Normalize</text><text class="sub" x="355" y="296" text-anchor="middle">structure + identity</text></g>
  ...
  <path data-ox-connector class="edge" d="M200 280H265"/><path data-ox-connector class="edge" d="M445 280H510"/><path data-ox-connector class="edge" stroke="var(--teal,#97aebd)" d="M670 280H735"/>
</svg>
```
...
```html
<svg data-ox-viz="layer-stack" class="oxv-layer" viewBox="0 0 960 600" role="img" aria-labelledby="layer-title layer-desc" style="max-width:100%;height:auto;background:var(--panel,#111411);color:var(--ink,#f4f2ef)">
  ...
  <style>.oxv-layer text{font-family:Inter,system-ui,sans-serif;fill:currentColor}.oxv-layer .band{fill:var(--bg,#0b0d0b);stroke:var(--hair,#212620);stroke-width:2}.oxv-layer .name{font-size:17px;font-weight:600}.oxv-layer .sub{font:12px "Spline Sans Mono",monospace;fill:var(--dim,#b7b6a3)}</style>
  ...
  <g data-ox-node data-ox-focus><rect x="100" y="180" width="760" height="100" rx="6" fill="var(--gold,#d9b654)" fill-opacity=".12" stroke="var(--gold,#d9b654)" stroke-width="2"/><text class="name" x="140" y="226">ox viz contract</text><text class="sub" x="140" y="252">catalog · deterministic rendering · lint</text></g>
...
```html
<svg data-ox-viz="timeline" class="oxv-time" viewBox="0 0 960 600" role="img" aria-labelledby="time-title time-desc" style="max-width:100%;height:auto;background:var(--panel,#111411);color:var(--ink,#f4f2ef)">
  ...
  <style>.oxv-time text{font-family:Inter,system-ui,sans-serif;fill:currentColor}.oxv-time .axis{stroke:var(--hair,#212620);stroke-width:4}.oxv-time .stem{stroke:var(--dim,#b7b6a3);stroke-width:2}.oxv-time .name{font-size:15px;font-weight:600}.oxv-time .date{font:11px "Spline Sans Mono",monospace;fill:var(--dim,#b7b6a3)}</style>
  ...
  <g data-ox-node data-ox-focus><line data-ox-connector x1="600" y1="300" x2="600" y2="210" stroke="var(--gold,#d9b654)" stroke-width="2"/><circle cx="600" cy="300" r="12" fill="var(--gold,#d9b654)"/><text class="name" x="600" y="178" text-anchor="middle">Human review</text><text class="date" x="600" y="198" text-anchor="middle">decision gate</text></g>
...
```html
<svg data-ox-viz="loop" class="oxv-loop" viewBox="0 0 960 600" role="img" aria-labelledby="loop-title loop-desc" style="max-width:100%;height:auto;background:var(--panel,#111411);color:var(--ink,#f4f2ef)">
  ...
  <defs><marker id="loop-arrow" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto"><path d="M0 0 8 3 0 6Z" fill="var(--dim,#b7b6a3)"/></marker></defs>
  <style>.oxv-loop text{font-family:Inter,system-ui,sans-serif;fill:currentColor}.oxv-loop .node{fill:var(--bg,#0b0d0b);stroke:var(--hair,#212620);stroke-width:2}.oxv-loop .name{font-size:15px;font-weight:600}.oxv-loop .sub{font:11px "Spline Sans Mono",monospace;fill:var(--dim,#b7b6a3)}.oxv-loop .edge{fill:none;stroke:var(--dim,#b7b6a3);stroke-width:2;marker-end:url(#loop-arrow)}.oxv-loop .write{fill:none;stroke:var(--teal,#97aebd);stroke-width:2;stroke-dasharray:6 5}</style>
