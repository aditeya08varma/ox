...
test-preflight: lint check-no-git-lfs-shell check-raw-writer-chokepoint check-session-meta-rmw test-all test-slow ## Pre-PR quality gate: lint + all unit tests + slow tests
