...
1. Audit `docs/ai/specs/codedb-temporal-distillation.md` and
   `docs/human/coes/2026-04-07-multi-node-write-conflicts.md` for
...
| `docs/ai/specs/codedb-temporal-distillation.md` | Unit 6 audits for team-tz references | Reader plan may also edit this file if it describes the extract surface | Low risk — coordinate via PR review. If both plans edit, rebase and merge prose. No architectural coupling. |
