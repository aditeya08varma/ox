...
// code (in-proc runJournal*InProc or the slow-tagged subprocess) captures
...
//
// This helper is untagged so both the fast in-proc journal tests and the
// slow-tagged end-to-end journal tests share one source of truth. Do not
