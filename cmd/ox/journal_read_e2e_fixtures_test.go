...
// journal_read_e2e_fixtures_test.go — low-level fixture stagers, date
// helpers, and the 12 fixture recipes per
// docs/ai/specs/journal-read-test-plan.md §3. The harness that wires up
// a per-test workspace is in journal_read_e2e_harness_test.go; the
// sanity test that exercises every recipe end-to-end is in
// journal_read_e2e_test.go.
//
...
// ---------------------------------------------------------------------------
// Recipes — 12 per docs/ai/specs/journal-read-test-plan.md §3
// ---------------------------------------------------------------------------
...
// rather than reaching into *journalE2E.
//
...
// neighbor does not break `ox journal show` for a different, well-formed
