...
// OMP discovers the portable Agent Skills convention at .agents/skills.
// Sharing this target with Codex and Gemini lets reconciliation write one
// projection when a project enables several AI coworkers.
